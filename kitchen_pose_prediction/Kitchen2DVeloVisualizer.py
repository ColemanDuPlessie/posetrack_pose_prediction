...
dataset_to_view = "60fps_velo_1024"
...
projection = (0, 1) # 0 = x, 1 = y, 2 = z

canvas = tk.Canvas(root, bg = "white", height = height, width = width)

def load_data():
    return torch.utils.data.DataLoader(BatchManager("preprocessed_data/" + dataset_to_view, 5, 5+batches_to_use))
